  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 right-4 z-30">
        <span className="bg-brand-violet text-brand-black text-[10px] font-bold uppercase px-2 py-1">
          Placeholder
        </span>
      </div>
      ...
      <div className="absolute bottom-0 left-0 p-6 md:p-12 z-20 w-full">
        ...
        <h3 className="text-2xl md:text-5xl font-black text-brand-white tracking-tighter mb-4">
          {project.title}
        </h3>
...
const Work: React.FC = () => {
  ...
  return (
    <div className="flex flex-col bg-brand-black text-brand-white min-h-screen selection:bg-brand-violet selection:text-brand-black">
      ...
      {/* --- CTA SECTION --- */}
      <section className="relative min-h-150 flex items-center justify-center px-4 py-24 md:py-32 bg-brand-violet text-brand-black overflow-hidden">
